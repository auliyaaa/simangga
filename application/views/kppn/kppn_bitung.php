                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('index/kppn_bitung'); ?>" class="breadcrumb-link">KPPN Bitung</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        document.getElementById("perbar_bopk").innerHTML = dataTable.getValue(3, 22);
    }
</script>
