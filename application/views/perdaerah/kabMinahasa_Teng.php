                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('index/kabMinahasa_Teng'); ?>" class="breadcrumb-link">Kab. Minahasa Tenggara</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        // DAU
        document.getElementById("pagu_dau").innerHTML = dataTable.getValue(5, 1);
        document.getElementById("real_dau").innerHTML = dataTable.getValue(5, 2);
        // document.getElementById("per_real_dau").innerHTML = fixPercentDAU + "%";
        document.getElementById("per_real_dau").innerHTML = dataTable.getValue(5, 3);
        document.getElementById("perbar_real_dau").innerHTML = dataTable.getValue(5, 3);

        // DBH
        document.getElementById("pg_dbh_tot").innerHTML = dataTable.getValue(5, 4);
        document.getElementById("real_dbh_tot").innerHTML = dataTable.getValue(5, 5);
        document.getElementById("per_real_dbh_tot").innerHTML = dataTable.getValue(5, 6);
        document.getElementById("perbar_real_dbh_tot").innerHTML = dataTable.getValue(5, 6);

        // DD
        document.getElementById("pg_dd_tot").innerHTML = dataTable.getValue(5, 11);
        document.getElementById("real_dd_tot").innerHTML = dataTable.getValue(5, 12);
        document.getElementById("per_real_dd_tot").innerHTML = dataTable.getValue(5, 13);
        document.getElementById("perbar_real_dd_tot").innerHTML = dataTable.getValue(5, 13);

        // DF
        document.getElementById("pg_df").innerHTML = dataTable.getValue(5, 7);
        document.getElementById("kontrak").innerHTML = dataTable.getValue(5, 8);
        document.getElementById("salur").innerHTML = dataTable.getValue(5, 9);
        document.getElementById("per_df").innerHTML = dataTable.getValue(5, 10);
        document.getElementById("perbar_df").innerHTML = dataTable.getValue(5, 10);

        // BOS
        document.getElementById("pg_bos_tot").innerHTML = dataTable.getValue(5, 14);
        document.getElementById("real_bos_tot").innerHTML = dataTable.getValue(5, 15);
        document.getElementById("per_real_bos_tot").innerHTML = dataTable.getValue(5, 16);
        document.getElementById("perbar_real_bos_tot").innerHTML = dataTable.getValue(5, 16);

        // BOP PAUD
        document.getElementById("pg_bopp_tot").innerHTML = dataTable.getValue(5, 17);
        document.getElementById("real_bopp_tot").innerHTML = dataTable.getValue(5, 18);
        document.getElementById("per_real_bopp_tot").innerHTML = dataTable.getValue(5, 19);
        document.getElementById("perbar_real_bopp_tot").innerHTML = dataTable.getValue(5, 19);

        // // BOP KESETARAAN
        document.getElementById("pg_bopk_tot").innerHTML = dataTable.getValue(5, 20);
        document.getElementById("real_bopk_tot").innerHTML = dataTable.getValue(5, 21);
        document.getElementById("per_real_bopk_tot").innerHTML = dataTable.getValue(5, 22);
        document.getElementById("perbar_real_bopk_tot").innerHTML = dataTable.getValue(5, 22);
    }
</script>
