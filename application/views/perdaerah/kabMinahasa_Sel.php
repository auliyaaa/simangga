                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('index/kabMinahasa_Sel'); ?>" class="breadcrumb-link">Kab. Minahasa Selatan</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        // DAU
        document.getElementById("pagu_dau").innerHTML = dataTable.getValue(4, 1);
        document.getElementById("real_dau").innerHTML = dataTable.getValue(4, 2);
        document.getElementById("per_real_dau").innerHTML = dataTable.getValue(4, 3);
        document.getElementById("perbar_real_dau").innerHTML = dataTable.getValue(4, 3);
        // document.getElementById("per_real_dau").innerHTML = fixPercentDAU + "%";

        // DBH
        document.getElementById("pg_dbh_tot").innerHTML = dataTable.getValue(4, 4);
        document.getElementById("real_dbh_tot").innerHTML = dataTable.getValue(4, 5);
        document.getElementById("per_real_dbh_tot").innerHTML = dataTable.getValue(4, 6);
        document.getElementById("perbar_real_dbh_tot").innerHTML = dataTable.getValue(4, 6);

        // DD
        document.getElementById("pg_dd_tot").innerHTML = dataTable.getValue(4, 11);
        document.getElementById("real_dd_tot").innerHTML = dataTable.getValue(4, 12);
        document.getElementById("per_real_dd_tot").innerHTML = dataTable.getValue(4, 13);
        document.getElementById("perbar_real_dd_tot").innerHTML = dataTable.getValue(4, 13);

        // DF
        document.getElementById("pg_df").innerHTML = dataTable.getValue(4, 7);
        document.getElementById("kontrak").innerHTML = dataTable.getValue(4, 8);
        document.getElementById("salur").innerHTML = dataTable.getValue(4, 9);
        document.getElementById("per_df").innerHTML = dataTable.getValue(4, 10);
        document.getElementById("perbar_df").innerHTML = dataTable.getValue(4, 10);

        // BOS
        document.getElementById("pg_bos_tot").innerHTML = dataTable.getValue(4, 14);
        document.getElementById("real_bos_tot").innerHTML = dataTable.getValue(4, 15);
        document.getElementById("per_real_bos_tot").innerHTML = dataTable.getValue(4, 16);
        document.getElementById("perbar_real_bos_tot").innerHTML = dataTable.getValue(4, 16);

        // BOP PAUD
        document.getElementById("pg_bopp_tot").innerHTML = dataTable.getValue(4, 17);
        document.getElementById("real_bopp_tot").innerHTML = dataTable.getValue(4, 18);
        document.getElementById("per_real_bopp_tot").innerHTML = dataTable.getValue(4, 19);
        document.getElementById("perbar_real_bopp_tot").innerHTML = dataTable.getValue(4, 19);

        // // BOP KESETARAAN
        document.getElementById("pg_bopk_tot").innerHTML = dataTable.getValue(4, 20);
        document.getElementById("real_bopk_tot").innerHTML = dataTable.getValue(4, 21);
        document.getElementById("per_real_bopk_tot").innerHTML = dataTable.getValue(4, 22);
        document.getElementById("perbar_real_bopk_tot").innerHTML = dataTable.getValue(4, 22);
    }
</script>
