                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('index/kota_Kotamobagu'); ?>" class="breadcrumb-link">Kota Kotamobagu</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        // DAU
        document.getElementById("pagu_dau").innerHTML = dataTable.getValue(14, 1);
        document.getElementById("real_dau").innerHTML = dataTable.getValue(14, 2);
        document.getElementById("per_real_dau").innerHTML = dataTable.getValue(14, 3);
        document.getElementById("perbar_real_dau").innerHTML = dataTable.getValue(14, 3);
        // document.getElementById("per_real_dau").innerHTML = fixPercentDAU + "%";

        // DBH
        document.getElementById("pg_dbh_tot").innerHTML = dataTable.getValue(14, 4);
        document.getElementById("real_dbh_tot").innerHTML = dataTable.getValue(14, 5);
        document.getElementById("per_real_dbh_tot").innerHTML = dataTable.getValue(14, 6);
        document.getElementById("perbar_real_dbh_tot").innerHTML = dataTable.getValue(14, 6);

        // DD
        document.getElementById("pg_dd_tot").innerHTML = dataTable.getValue(14, 11);
        document.getElementById("real_dd_tot").innerHTML = dataTable.getValue(14, 12);
        document.getElementById("per_real_dd_tot").innerHTML = dataTable.getValue(14, 13);
        document.getElementById("perbar_real_dd_tot").innerHTML = dataTable.getValue(14, 13);

        // DF
        document.getElementById("pg_df").innerHTML = dataTable.getValue(14, 7);
        document.getElementById("kontrak").innerHTML = dataTable.getValue(14, 8);
        document.getElementById("salur").innerHTML = dataTable.getValue(14, 9);
        document.getElementById("per_df").innerHTML = dataTable.getValue(14, 10);
        document.getElementById("perbar_df").innerHTML = dataTable.getValue(14, 10);

        // BOS
        document.getElementById("pg_bos_tot").innerHTML = dataTable.getValue(14, 14);
        document.getElementById("real_bos_tot").innerHTML = dataTable.getValue(14, 15);
        document.getElementById("per_real_bos_tot").innerHTML = dataTable.getValue(14, 16);
        document.getElementById("perbar_real_bos_tot").innerHTML = dataTable.getValue(14, 16);

        // BOP PAUD
        document.getElementById("pg_bopp_tot").innerHTML = dataTable.getValue(14, 17);
        document.getElementById("real_bopp_tot").innerHTML = dataTable.getValue(14, 18);
        document.getElementById("per_real_bopp_tot").innerHTML = dataTable.getValue(14, 19);
        document.getElementById("perbar_real_bopp_tot").innerHTML = dataTable.getValue(14, 19);

        // // BOP KESETARAAN
        document.getElementById("pg_bopk_tot").innerHTML = dataTable.getValue(14, 20);
        document.getElementById("real_bopk_tot").innerHTML = dataTable.getValue(14, 21);
        document.getElementById("per_real_bopk_tot").innerHTML = dataTable.getValue(14, 22);
        document.getElementById("perbar_real_bopk_tot").innerHTML = dataTable.getValue(14, 22);
    }
</script>
