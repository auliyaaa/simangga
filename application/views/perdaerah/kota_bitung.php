                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('index/kota_bitung'); ?>" class="breadcrumb-link">Kota Bitung</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        //     return (x/y)*100;
        // }
        // var fixPercentDAU = Percent(dataTable.getValue(17, 2),dataTable.getValue(2, 1)).toFixed(2);
        ...
        // DAU
        document.getElementById("pagu_dau").innerHTML = dataTable.getValue(17, 1);
        document.getElementById("real_dau").innerHTML = dataTable.getValue(17, 2);
        document.getElementById("per_real_dau").innerHTML = dataTable.getValue(17, 3);
        document.getElementById("perbar_real_dau").innerHTML = dataTable.getValue(17, 3);
        // document.getElementById("per_real_dau").innerHTML = fixPercentDAU + "%";

        // DBH
        document.getElementById("pg_dbh_tot").innerHTML = dataTable.getValue(17, 4);
        document.getElementById("real_dbh_tot").innerHTML = dataTable.getValue(17, 5);
        document.getElementById("per_real_dbh_tot").innerHTML = dataTable.getValue(17, 6);
        document.getElementById("perbar_real_dbh_tot").innerHTML = dataTable.getValue(17, 6);

        // DD
        document.getElementById("pg_dd_tot").innerHTML = dataTable.getValue(17, 11);
        document.getElementById("real_dd_tot").innerHTML = dataTable.getValue(17, 12);
        document.getElementById("per_real_dd_tot").innerHTML = dataTable.getValue(17, 13);
        document.getElementById("perbar_real_dd_tot").innerHTML = dataTable.getValue(17, 13);

        // DF
        document.getElementById("pg_df").innerHTML = dataTable.getValue(17, 7);
        document.getElementById("kontrak").innerHTML = dataTable.getValue(17, 8);
        document.getElementById("salur").innerHTML = dataTable.getValue(17, 9);
        document.getElementById("per_df").innerHTML = dataTable.getValue(17, 10);
        document.getElementById("perbar_df").innerHTML = dataTable.getValue(17, 10);

        // BOS
        document.getElementById("pg_bos_tot").innerHTML = dataTable.getValue(17, 14);
        document.getElementById("real_bos_tot").innerHTML = dataTable.getValue(17, 15);
        document.getElementById("per_real_bos_tot").innerHTML = dataTable.getValue(17, 16);
        document.getElementById("perbar_real_bos_tot").innerHTML = dataTable.getValue(17, 16);

        // BOP PAUD
        document.getElementById("pg_bopp_tot").innerHTML = dataTable.getValue(17, 17);
        document.getElementById("real_bopp_tot").innerHTML = dataTable.getValue(17, 18);
        document.getElementById("per_real_bopp_tot").innerHTML = dataTable.getValue(17, 19);
        document.getElementById("perbar_real_bopp_tot").innerHTML = dataTable.getValue(17, 19);

        // // BOP KESETARAAN
        document.getElementById("pg_bopk_tot").innerHTML = dataTable.getValue(17, 20);
        document.getElementById("real_bopk_tot").innerHTML = dataTable.getValue(17, 21);
        document.getElementById("per_real_bopk_tot").innerHTML = dataTable.getValue(17, 22);
        document.getElementById("perbar_real_bopk_tot").innerHTML = dataTable.getValue(17, 22);
    }
</script>
