                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('index/kota_tomoho'); ?>" class="breadcrumb-link">Kota Tomohon</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        // DAU
        document.getElementById("pagu_dau").innerHTML = dataTable.getValue(7, 1);
        document.getElementById("real_dau").innerHTML = dataTable.getValue(7, 2);
        document.getElementById("per_real_dau").innerHTML = dataTable.getValue(7, 3);
        document.getElementById("perbar_real_dau").innerHTML = dataTable.getValue(7, 3);
        // document.getElementById("per_real_dau").innerHTML = fixPercentDAU + "%";

        // DBH
        document.getElementById("pg_dbh_tot").innerHTML = dataTable.getValue(7, 4);
        document.getElementById("real_dbh_tot").innerHTML = dataTable.getValue(7, 5);
        document.getElementById("per_real_dbh_tot").innerHTML = dataTable.getValue(7, 6);
        document.getElementById("perbar_real_dbh_tot").innerHTML = dataTable.getValue(7, 6);

        // DD
        document.getElementById("pg_dd_tot").innerHTML = dataTable.getValue(7, 11);
        document.getElementById("real_dd_tot").innerHTML = dataTable.getValue(7, 12);
        document.getElementById("per_real_dd_tot").innerHTML = dataTable.getValue(7, 13);
        document.getElementById("perbar_real_dd_tot").innerHTML = dataTable.getValue(7, 13);

        // DF
        document.getElementById("pg_df").innerHTML = dataTable.getValue(7, 7);
        document.getElementById("kontrak").innerHTML = dataTable.getValue(7, 8);
        document.getElementById("salur").innerHTML = dataTable.getValue(7, 9);
        document.getElementById("per_df").innerHTML = dataTable.getValue(7, 10);
        document.getElementById("perbar_df").innerHTML = dataTable.getValue(7, 10);

        // BOS
        document.getElementById("pg_bos_tot").innerHTML = dataTable.getValue(7, 14);
        document.getElementById("real_bos_tot").innerHTML = dataTable.getValue(7, 15);
        document.getElementById("per_real_bos_tot").innerHTML = dataTable.getValue(7, 16);
        document.getElementById("perbar_real_bos_tot").innerHTML = dataTable.getValue(7, 16);

        // BOP PAUD
        document.getElementById("pg_bopp_tot").innerHTML = dataTable.getValue(7, 17);
        document.getElementById("real_bopp_tot").innerHTML = dataTable.getValue(7, 18);
        document.getElementById("per_real_bopp_tot").innerHTML = dataTable.getValue(7, 19);
        document.getElementById("perbar_real_bopp_tot").innerHTML = dataTable.getValue(7, 19);

        // // BOP KESETARAAN
        document.getElementById("pg_bopk_tot").innerHTML = dataTable.getValue(7, 20);
        document.getElementById("real_bopk_tot").innerHTML = dataTable.getValue(7, 21);
        document.getElementById("per_real_bopk_tot").innerHTML = dataTable.getValue(7, 22);
        document.getElementById("perbar_real_bopk_tot").innerHTML = dataTable.getValue(7, 22);
    }
</script>
