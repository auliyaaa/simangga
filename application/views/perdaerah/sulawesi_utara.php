                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url('index/sulawesi_utara'); ?>" class="breadcrumb-link">Sulawesi Utara</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        // DAU
        document.getElementById("pagu_dau").innerHTML = dataTable.getValue(2, 1);
        document.getElementById("real_dau").innerHTML = dataTable.getValue(2, 2);
        ...
        document.getElementById("per_real_bopk_tot").innerHTML = dataTable.getValue(2, 22);
        document.getElementById("perbar_real_bopk_tot").innerHTML = dataTable.getValue(2, 22);
    }
</script>
