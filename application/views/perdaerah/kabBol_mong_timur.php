...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        document.getElementById("perbar_real_dau").innerHTML = dataTable.getValue(13, 3);
        ...
        document.getElementById("perbar_real_dbh_tot").innerHTML = dataTable.getValue(13, 6);
        ...
        document.getElementById("perbar_real_dd_tot").innerHTML = dataTable.getValue(13, 13);
        ...
        document.getElementById("perbar_df").innerHTML = dataTable.getValue(13, 10);
        ...
        document.getElementById("perbar_real_bos_tot").innerHTML = dataTable.getValue(13, 16);
        ...
        document.getElementById("perbar_real_bopp_tot").innerHTML = dataTable.getValue(13, 19);
        ...
        document.getElementById("perbar_real_bopk_tot").innerHTML = dataTable.getValue(13, 22);
    }
</script>
